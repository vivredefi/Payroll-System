...
<div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <h2 class="management">Account Management</h2> 
            ...
            <table class="table table-bordered table-striped text-center p-1" id="table">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a class='btn editbtn btn-sm' ><img src='editicon.png' alt='Edit' height='15' width='15'></a></td>";
                        echo "<td><a class='btn deletebtn '><img src='deleteicon.png' alt='Edit' height='17' width='15'></a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
